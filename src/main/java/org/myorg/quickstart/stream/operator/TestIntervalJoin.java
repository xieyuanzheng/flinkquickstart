...
public class TestIntervalJoin {
    public static void main(String[] args) throws Exception{
        ...
        //key1=key2 && leftTs-2.txt < rights  < leftTs+2.txt
        keyedStream.intervalJoin(otherKeyedStream)
                .between(Time.milliseconds(2),Time.milliseconds(100))
                .upperBoundExclusive()
                .lowerBoundExclusive()
                .process(new ProcessJoinFunction<Transcript, Student, Tuple5<String,String,String,String,Integer>>() {

                    @Override
                    public void processElement(Transcript transcript, Student student, Context context, Collector<Tuple5<String, String, String, String, Integer>> out) throws Exception {
    ...
    public static final Transcript[] TRANSCRIPTS = new Transcript[] {
        ...
        new Transcript("2.txt","李四","语文",78,System.currentTimeMillis()),
    ...
    public static final Student[] STUDENTS = new Student[]{
            ...
            new Student("2.txt","李四","class1",System.currentTimeMillis()),
