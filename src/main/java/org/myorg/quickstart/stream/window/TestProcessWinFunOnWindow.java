package org.myorg.quickstart.stream.window;
...
public class TestProcessWinFunOnWindow {
    public static void main(String[] args) throws Exception{
        ...
        //求各班级英语总分
        DataStream<Double> avgScore = input.keyBy(0).countWindow(2)
                .process(new MyProcessWinFunction());
        avgScore.print();

        env.execute("TestProcessWinFunOnWindow");
    }
    ...
    private static class MyProcessWinFunction
